...
public class MenuDemo implements ActionListener {
    ...
    ImageIcon setIcon=new ImageIcon("swing/iconps.png");
    ImageIcon clearIcon=new ImageIcon("swing/jsicon.png");
    ImageIcon resumeIcon=new ImageIcon("swing/javaicon.png");
